  ...
  */
  me.MsgGetKontoUmsaetze = function (konto, fromDate, toDate, cb) {
    ...
    if (fromDate === null && toDate === null) {
      HKKAZ = Helper.newSegFromArray('HKKAZ', 7, [[konto.iban, konto.bic, konto.kontoNr, konto.unterKonto, konto.ctryCode, konto.blz], 'N'])
    } else {
      HKKAZ = Helper.newSegFromArray('HKKAZ', 7, [[konto.iban, konto.bic, konto.kontoNr, konto.unterKonto, konto.ctryCode, konto.blz], 'N', Helper.convertDateToDFormat(fromDate), Helper.convertDateToDFormat(toDate)])
    }
    msg.addSeg(HKKAZ)
    // abschicken
    me.SendMsgToDestination(msg, function (error, recvMsg) {
